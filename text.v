...
void main()
{
    ...
    light = vec4(ambientLight.rgb, 1.0);
    light += calcDirectionalLight(directionalLight, mvVertexPos, mvVertexNormal);
    light += calcPointLight(pointLight, mvVertexPos, mvVertexNormal); 
}